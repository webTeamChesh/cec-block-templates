...
const site_search = `
  <script>
      ...
      const doSearch = () => {
        ...
        {
          window.location.href="/search.aspx?search_keywords=" + encodeURIComponent(search);
        }
      }
        ...
        <div class="row">
          <div class="col-auto">
            ...
            >
                ...
                <div class="col">
                <div class="col-12 w-100 text-end" style="font-weight: 600">
              ...
              >
                ...
                <div class=" col-12 w-100 text-end cec-search-site">
                    <label for="searchTextBox" class="hidden sys_search-label">Search</label>
                    <input type="text" value="Enter keywords" id="searchTextBox" class="sys_searchbox" >
                    <input type="button" id="SearchQueryControl_SearchButton" value="Search" class="sys_button sys_searchbutton sys_search-button" />
                </div>
                </div>
        </div>
      </div>
